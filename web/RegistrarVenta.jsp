                    ...
                    <form action="Controlador?menu=NuevaVenta" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="nombrescliente" value="${c.getNom()}" placeholder="Datos Cliente" class="form-control" readonly="readonly">
                                </div>                           
                            </div>
                            <!--DATOS DEL PRODUCTO-->
                            <div class="form-group">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    <input type="text" name="precio" value="${producto.getPre()}" class="form-control" placeholder="$0.00" readonly="readonly">                                
                                </div>                           
                                <div class="col-sm-3">
                                    <input type="number" value="1" name="cant" placeholder="" class="form-control">
                                </div>  
                                <div class="col-sm-3.1">
                                    <input type="text" name="stock" value="${producto.getStock()}" placeholder="Existencia" class="form-control" readonly="readonly">
                                </div>  
                            </div>
                                ...
                                <c:forEach var="list" items="${lista}">
                                    <tr class="text-center">
                                        ...
                                        <!--<td class="d-flex">
                                            ...
                                            <a href="#" class="btn btn-danger" style="margin-left: 5px">Borrar</a>
                                        </td>-->
                                    </tr>
                                </c:forEach>
                    ...
                    <div class="card-footer" >
                        <div class="row">
                            ...
                            <div class="col-sm-6 ml-auto d-flex">                                
                                ...
                                <input type="text" name="txtTotal" value="$${totalpagar}0" class="form-control text-center font-weight-bold" style="font-size: 18px;" readonly="readonly">
                            </div>
                        </div>                        
                    </div>
                </div>
